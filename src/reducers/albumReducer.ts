...
export type AlbumActions = ReducerActions<AlbumWithProjects> | { type: 'changed_title'; title: string } | { type: 'changed_notes'; notes: string } | { type: 'changed_release_date'; release_date: string } | { type: 'added_project'; project: Project } | { type: 'removed_project'; projectId: string };
